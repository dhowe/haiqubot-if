...
router.post('/document/:conn/:db/:coll/edit_doc_skip', function (req, res, next) {

    console.log('/document/:conn/:db/:coll/edit_doc_skip');
...
router.post('/document/:conn/:db/:coll/edit_doc_select', function (req, res, next) {

    console.log('/document/:conn/:db/:coll/edit_doc_select');
...
router.post('/document/:conn/:db/:coll/edit_doc', function (req, res, next) {
    ...
    console.log('/document/:conn/:db/:coll/edit_doc');
